                    ...
                    <?php foreach ($data as $value): ?>
                        <li class="portfolio-item gutter">
                            <div class="portfolio">
                                ...
                                <img src="<?php echo base_url() ?>assets/images/archive/<?php echo $value->Img ?>">                        
                                <div class="portfolio-info">
                                    <h3 class="project-title"><?php echo $value->Konten ?></h3>
                                    <a href="#" class="links">Iron Bird Logistics</a>
                                </div>
                                <ul class="portfolio-details">
                                    <li><a class="tt-lightbox" href="<?php echo base_url() ?>assets/images/archive/<?php echo $value->Img ?>"><i class="fa fa-search"></i></a></li>
                                </ul>
                            </div>
                        </li>
                    <?php endforeach ?>    
