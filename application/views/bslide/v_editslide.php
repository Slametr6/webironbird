                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="<?php echo base_url() ?>admin_slide/update/<?php echo str_replace(array('+', '=', '/'), array('-', '_', '~'), $this->encryption->encrypt($data->idSlide)) ?>" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="Img" type="file">
                                             <img id="blah" src="<?php echo base_url('/assets/images/slider/') . $data->Img; ?>" style="width:150px;height:100px">
